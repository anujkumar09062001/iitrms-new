  ...
  render() {
    return (
      <div className="rms-footer">
        <Grid className="rms-footer-main-grid">
          <Grid.Row></Grid.Row>
          <Grid.Row>
            <Grid.Column computer={1} mobile={2}></Grid.Column>
            <Grid.Column computer={6} mobile={14} textAlign="justified">
              <Grid.Row>
                <p className="rms-footer-main">
                  Mechanical & Industrial Engineering Department, IIT Roorkee
                  247667 , Uttarakhand, India
                </p>
              </Grid.Row>
              <Grid.Row>
                <p className="rms-footer-number-1">
                  <span id="rms-footer-number-sign">P </span>1234567890
                </p>
              </Grid.Row>
              <Grid.Row>
                <p className="rms-footer-number-2">
                  <span id="rms-footer-number-sign">M </span>1234567890
                </p>
              </Grid.Row>

              <Grid as="div" className="rms-footer-social-links">
                <Grid.Column width={1} className="rms-footer-social">
                  <a href="">
                    <img src={linkedIn} width="25px" />
                  </a>
                </Grid.Column>
                <Grid.Column width={1} className="rms-footer-social-fb">
                  <a href="">
                    <img src={fB} width="14px" />
                  </a>
                </Grid.Column>
                <Grid.Column width={1} className="rms-footer-social">
                  <a href="">
                ...
                <Grid.Column width={1} className="rms-footer-social-in">
                  <a href="">
        ...
        <Grid className="rms-footer-main-grid">
          ...
          <Grid.Column computer={10}>
            <p className="rms-footer-copyright">
